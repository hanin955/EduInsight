                        ...
                        <div className='flex flex-col'>
                            ...
                            <form className='mt-8 flex flex-col gap-4' onSubmit={handleSubmit}>
                                <div className='grid grid-cols-2 gap-4'>
                                    <div>
                                        <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Prénom</label>
                                        <input
                                            name="firstName"
                                            type="text"
                                    ...
                                    <div>
                                        <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Nom</label>
                                        <input
                                            name="lastName"
                                            type="text"
                                            value={form.lastName}
                                ...
                                <div>
                                    <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Rôle</label>
                                    <select
                                        name="role"
                                        value={form.role}
                                        onChange={handleChange}
                                        className='w-full px-4 py-3 bg-white border border-slate-300 rounded-lg outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 text-blue-900'
                                    >
                                ...
                                <div>
                                    <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Speciality</label>
                                    <input
                                        name="speciality"
                                        type="text"
                                ...
                                {form.role === 'student' && (
                                    <div>
                                        <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Level</label>
                                        <select
                                            name="level"
                                            value={form.level}
                                            onChange={handleChange}
                                ...
                                <div>
                                    <label className='block text-blue-900 text-sm mb-2 text-left font-medium'>Confirm password</label>
                                    <input
